...
export class FightProperty {
  ...
  public static init() {
    ...
    this.fightProp[FightProperties.FIGHT_PROP_BASE_ATTACK] = 3000;
    this.fightProp[FightProperties.FIGHT_PROP_CRITICAL] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CRITICAL_HURT] = 2;
    this.fightProp[FightProperties.FIGHT_PROP_CHARGE_EFFICIENCY] = 2;
    this.fightProp[FightProperties.FIGHT_PROP_ELEMENT_MASTERY] = 200;
    this.fightProp[FightProperties.FIGHT_PROP_MAX_ROCK_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_MAX_ICE_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_MAX_WATER_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_MAX_FIRE_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_MAX_ELEC_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_MAX_GRASS_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_MAX_WIND_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_ROCK_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_ICE_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_WATER_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_FIRE_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_ELEC_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_GRASS_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_WIND_ENERGY] = 1;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_HP] = 50000;
    this.fightProp[FightProperties.FIGHT_PROP_CUR_DEFENSE] = 3000;

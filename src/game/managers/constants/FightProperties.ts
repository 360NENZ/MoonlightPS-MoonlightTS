...
const fightProp: { [type: number]: number } = {};

export function getAll() {
  fightProp[FightProperties.FIGHT_PROP_BASE_HP] = 50000;
  fightProp[FightProperties.FIGHT_PROP_MAX_HP] = 50000;
  fightProp[FightProperties.FIGHT_PROP_BASE_DEFENSE] = 3000;
  fightProp[FightProperties.FIGHT_PROP_BASE_ATTACK] = 3000;
  fightProp[FightProperties.FIGHT_PROP_CRITICAL] = 1;
  fightProp[FightProperties.FIGHT_PROP_CRITICAL_HURT] = 2;
  fightProp[FightProperties.FIGHT_PROP_CHARGE_EFFICIENCY] = 2;
  fightProp[FightProperties.FIGHT_PROP_ELEMENT_MASTERY] = 200;
  fightProp[FightProperties.FIGHT_PROP_MAX_ROCK_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_MAX_ICE_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_MAX_WATER_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_MAX_FIRE_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_MAX_ELEC_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_MAX_GRASS_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_MAX_WIND_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_ROCK_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_ICE_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_WATER_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_FIRE_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_ELEC_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_GRASS_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_WIND_ENERGY] = 1;
  fightProp[FightProperties.FIGHT_PROP_CUR_HP] = 50000;
  fightProp[FightProperties.FIGHT_PROP_CUR_DEFENSE] = 3000;
  fightProp[FightProperties.FIGHT_PROP_CUR_ATTACK] = 3000;
  fightProp[FightProperties.FIGHT_PROP_SKILL_CD_MINUS_RATIO] = 1;
  fightProp[FightProperties.FIGHT_PROP_SPEED_PERCENT] = 2;

    const propMap: { [type: number]: PropValue } = {}
    for (const type in fightProp){
